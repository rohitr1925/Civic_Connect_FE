...
const sclassSlice = createSlice({
    ...
    reducers: {
        ...
        getPollsforadminsuccess: (state, action) => {
            state.adminPollslist = action.payload;
            state.loading = false;
            state.error = null;
            state.getresponse = null;
        },
        postVotesuccess: (state, action) => {
            state.votesuccess = action.payload;
            state.loading = false;
            state.error = null;
            state.getresponse = null;
        },
        ...
        getTeacherdetailsSuccess: (state, action) => {
            state.teacherDetails = action.payload;
            console.log(action.payload,'teacherpayload')
            state.loading = false;
            state.error = null;
        },
